...
while play:
    ...
    if helpVillage == "Y":
        ...
        play = death(player.name, player.gold, player.weapon, play)
        continue
    ...
    if dragonFight1 == "TRAIN":
        ...
        death(player.name, player.gold, player.weapon, play)
    ...
    play = win(player.name, player.gold, weapon)
